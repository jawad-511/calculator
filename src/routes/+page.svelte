...
<div
    class="bg-white min-h-[30rem] w-[20rem] rounded-3xl grid grid-cols-4 gap-1 p-6 font-semibold text-3xl shadow-2xl"
>
    <div
        class="
            bg-blue-600
    ...
    <button on:click={clear} class="bg-slate-950 rounded-full w-14 h-14 text-white">AC</button>
